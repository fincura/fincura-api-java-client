...
public class FilesApi {
    ...
    /**
     * Build call for createBulkFile
     * @param bulkFileCreate  (optional)
     ...
     */
    public okhttp3.Call createBulkFileCall(BulkFileCreate bulkFileCreate, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = bulkFileCreate;

        // create path and map variables
        String localVarPath = "/v1/bulk-file";
    ...
    private okhttp3.Call createBulkFileValidateBeforeCall(BulkFileCreate bulkFileCreate, final ApiCallback _callback) throws ApiException {
        

        okhttp3.Call localVarCall = createBulkFileCall(bulkFileCreate, _callback);
        return localVarCall;
     ...
     */
    public BulkFileCreate createBulkFile(BulkFileCreate bulkFileCreate) throws ApiException {
        ApiResponse<BulkFileCreate> localVarResp = createBulkFileWithHttpInfo(bulkFileCreate);
     ...
     * Add a new file to Fincura that maps to many borrowers. Requires use of a specific file processor per file format. Speak with you Fincura account manager about available options on your account.       POST /v1/bulk-file HTTP/1.1     Host: api.fincura.com     Accept: application/json     Authorization: Bearer eyJ0e...nFTRKTbcg     Content-Type: application/json      {         \&quot;processor_key\&quot;: \&quot;6e64724a-25fc-4e1a-8071-1ef29845ab1d\&quot;,         \&quot;media_type\&quot;: \&quot;application/pdf\&quot;\&quot;     }       The above request will create a new document record in Fincura and return a url to send the file to, as seen below.      {         \&quot;uuid\&quot;: \&quot;3e3ca543-23d3-403b-82cd-516ef478a819\&quot;,         \&quot;upload_url\&quot;: \&quot;https://upload.fincura.com/3e3ca543-23d3-403b-82cd-516ef478a819/document.pdf?signature&#x3D;mWFg4xsgm4EtFEt\&quot;     }  In a subsequent request, the file can be sent to the &#x60;upload_url&#x60; via [HTTP PUT](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/PUT). The &#x60;Content-Length&#x60; and &#x60;Content-Type&#x60; headers are required. The &#x60;Content-Type&#x60; should match the &#x60;media_type&#x60; from the previous request.      PUT /3e3ca543-23d3-403b-82cd-516ef478a819/document.pdf?signature&#x3D;mWFg4xsgm4EtFEt HTTP/1.1     Host: upload.fincura.com     Content-Length: 18828     Content-Type: application/pdf          {FILE  DATA}  Fincura will begin processing the file once it has been completely uploaded.
     * @param bulkFileCreate  (optional)
     * @return ApiResponse&lt;BulkFileCreate&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BulkFileCreate> createBulkFileWithHttpInfo(BulkFileCreate bulkFileCreate) throws ApiException {
        okhttp3.Call localVarCall = createBulkFileValidateBeforeCall(bulkFileCreate, null);
        Type localVarReturnType = new TypeToken<BulkFileCreate>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Submit a new BulkFile (asynchronously)
     * Add a new file to Fincura that maps to many borrowers. Requires use of a specific file processor per file format. Speak with you Fincura account manager about available options on your account.       POST /v1/bulk-file HTTP/1.1     Host: api.fincura.com     Accept: application/json     Authorization: Bearer eyJ0e...nFTRKTbcg     Content-Type: application/json      {         \&quot;processor_key\&quot;: \&quot;6e64724a-25fc-4e1a-8071-1ef29845ab1d\&quot;,         \&quot;media_type\&quot;: \&quot;application/pdf\&quot;\&quot;     }       The above request will create a new document record in Fincura and return a url to send the file to, as seen below.      {         \&quot;uuid\&quot;: \&quot;3e3ca543-23d3-403b-82cd-516ef478a819\&quot;,         \&quot;upload_url\&quot;: \&quot;https://upload.fincura.com/3e3ca543-23d3-403b-82cd-516ef478a819/document.pdf?signature&#x3D;mWFg4xsgm4EtFEt\&quot;     }  In a subsequent request, the file can be sent to the &#x60;upload_url&#x60; via [HTTP PUT](https://developer.mozilla.org/en-US/docs/Web/HTTP/Methods/PUT). The &#x60;Content-Length&#x60; and &#x60;Content-Type&#x60; headers are required. The &#x60;Content-Type&#x60; should match the &#x60;media_type&#x60; from the previous request.      PUT /3e3ca543-23d3-403b-82cd-516ef478a819/document.pdf?signature&#x3D;mWFg4xsgm4EtFEt HTTP/1.1     Host: upload.fincura.com     Content-Length: 18828     Content-Type: application/pdf          {FILE  DATA}  Fincura will begin processing the file once it has been completely uploaded.
     * @param bulkFileCreate  (optional)
     ...
     */
    public okhttp3.Call createBulkFileAsync(BulkFileCreate bulkFileCreate, final ApiCallback<BulkFileCreate> _callback) throws ApiException {

        okhttp3.Call localVarCall = createBulkFileValidateBeforeCall(bulkFileCreate, _callback);
        Type localVarReturnType = new TypeToken<BulkFileCreate>(){}.getType();
    ...
    /**
     * Build call for retrieveBulkFile
     * @param uuid  (required)
     * @param _callback Callback for upload/download progress
     * @return Call to execute
     * @throws ApiException If fail to serialize the request body object
     ...
     */
    public okhttp3.Call retrieveBulkFileCall(String uuid, final ApiCallback _callback) throws ApiException {
        Object localVarPostBody = null;

        // create path and map variables
        String localVarPath = "/v1/bulk-file/{uuid}"
            .replaceAll("\\{" + "uuid" + "\\}", localVarApiClient.escapeString(uuid.toString()));
    ...
    @SuppressWarnings("rawtypes")
    private okhttp3.Call retrieveBulkFileValidateBeforeCall(String uuid, final ApiCallback _callback) throws ApiException {
        
        // verify the required parameter 'uuid' is set
        if (uuid == null) {
            throw new ApiException("Missing the required parameter 'uuid' when calling retrieveBulkFile(Async)");
        }
        

        okhttp3.Call localVarCall = retrieveBulkFileCall(uuid, _callback);
        return localVarCall;
     ...
     */
    public BulkFileRead retrieveBulkFile(String uuid) throws ApiException {
        ApiResponse<BulkFileRead> localVarResp = retrieveBulkFileWithHttpInfo(uuid);
        return localVarResp.getData();
    }
     ...
     * Retrieve a bulk file submitted to Fincura
     * @param uuid  (required)
     * @return ApiResponse&lt;BulkFileRead&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     * @http.response.details
     <table summary="Response Details" border="1">
        <tr><td> Status Code </td><td> Description </td><td> Response Headers </td></tr>
     ...
     */
    public ApiResponse<BulkFileRead> retrieveBulkFileWithHttpInfo(String uuid) throws ApiException {
        okhttp3.Call localVarCall = retrieveBulkFileValidateBeforeCall(uuid, null);
        Type localVarReturnType = new TypeToken<BulkFileRead>(){}.getType();
        return localVarApiClient.execute(localVarCall, localVarReturnType);
    }

    /**
     * Retrieve a BulkFile (asynchronously)
     * Retrieve a bulk file submitted to Fincura
     * @param uuid  (required)
     * @param _callback The callback to be executed when the API call finishes
     * @return The request call
     ...
     */
    public okhttp3.Call retrieveBulkFileAsync(String uuid, final ApiCallback<BulkFileRead> _callback) throws ApiException {

        okhttp3.Call localVarCall = retrieveBulkFileValidateBeforeCall(uuid, _callback);
        Type localVarReturnType = new TypeToken<BulkFileRead>(){}.getType();
        localVarApiClient.executeAsync(localVarCall, localVarReturnType, _callback);
        return localVarCall;
    }
    ...
    /**
     * Get a DocumentFile (asynchronously)
     * Retrieve a file submitted to Fincura
     * @param uuid  (required)
     * @param borrowerUuid Borrower to filter results for (optional)
     * @param _callback The callback to be executed when the API call finishes
