...
public class EmbeddedWorkflow {
  ...
  public static final String SERIALIZED_NAME_EXTERNAL_USER_LABEL = "external_user_label";
  @SerializedName(SERIALIZED_NAME_EXTERNAL_USER_LABEL)
  private String externalUserLabel;
  ...
  **/
  ...
  public EmbeddedWorkflow externalUserId(String externalUserId) {
   ...
   /**
   * Id to identify the user performing the work (e.g. email or username)
   * @return externalUserId
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Id to identify the user performing the work (e.g. email or username)")
  ...
  public EmbeddedWorkflow externalUserLabel(String externalUserLabel) {
    
    this.externalUserLabel = externalUserLabel;
    return this;
  }

   /**
   * Human readable label to identify the user performing the work (e.g. name)
   * @return externalUserLabel
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Human readable label to identify the user performing the work (e.g. name)")

  public String getExternalUserLabel() {
    return externalUserLabel;
  }


  public void setExternalUserLabel(String externalUserLabel) {
    this.externalUserLabel = externalUserLabel;
  }
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.uuid, embeddedWorkflow.uuid) &&
        ...
        Objects.equals(this.externalUserId, embeddedWorkflow.externalUserId) &&
        Objects.equals(this.externalUserLabel, embeddedWorkflow.externalUserLabel);
  }

  @Override
  public int hashCode() {
    return Objects.hash(uuid, documentFileUuid, embedType, createdDate, exitStep, redirectUrl, uiControls, loaded, loadWorkflowUrl, externalUserId, externalUserLabel);
  }
  ...
  public String toString() {
    ...
    sb.append("    externalUserLabel: ").append(toIndentedString(externalUserLabel)).append("\n");
    sb.append("}");
    return sb.toString();
  }
